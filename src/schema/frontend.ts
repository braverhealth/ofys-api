      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            description:
              'Nombre max de messages à retourner (max 100, défaut 50)',
          },
          {
            in: 'query',
...
**Sécurité**: Authentification requise (braverJwt)`,
                  ...
                  invalidParticipant: {
                    value: {
                      error: {
                        ...
                        message:
                          "Le participant avec l'ID 'prof-123' n'existe pas",
                        details: {
    ...
    '/fils/activites': {
      get: {
        tags: ['Temps Réel'],
        summary:
          'Établir une connexion WebSocket pour les activités en temps réel',
