 ...
 */
import { ParticipantStatus, ParticipantPermission, Nullable, Gender, } from './common.js';
// ============================================================================
...
export const AttachmentCreate = Type.Object({
    ...
    contenuBase64: Type.Optional(Type.String({
        format: 'byte',
    ...
    urlTelechargement: Type.Optional(Type.String({
        format: 'uri',
...
export const ThreadSummary = Type.Object({
    ...
    enSourdineJusqua: Type.Optional(Type.String({
        format: 'date-time',
    ...
    resumeDepuisDebut: Type.Optional(Type.String({
        description: 'Résumé IA de la discussion depuis le début (markdown)',
    })),
    resumeDepuisDerniereInteraction: Type.Optional(Type.String({
...
export const PatientDetails = Type.Object({
    ...
    sexeNaissance: Type.Optional(Nullable(Gender)),
    dateNaissance: Type.Optional(Nullable(Type.String({ format: 'date' }))),
    nam: Type.Optional(Nullable(Type.String({ description: "Numéro d'assurance maladie" }))),
});
...
export const ThreadUpdate = Type.Partial(Type.Object({
...
export const ThreadParticipantRef = Type.Partial(Type.Object({
...
export const Profession = Type.Object({
    ...
    type: ProfessionType,
    labels: Type.Partial(Type.Object({
        fr_M: Type.String(),
        fr_F: Type.String(),
        fr_O: Type.String(),
        en_M: Type.String(),
